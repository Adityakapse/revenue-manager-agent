...
|----------------|---------|
| Model | Provider-configurable via `LLM_PROVIDER` — deployed on **Groq** (`llama-3.3-70b-versatile`); Google Gemini also supported (was blocked with a 403 from Render's server IP). Temperature 0. |
